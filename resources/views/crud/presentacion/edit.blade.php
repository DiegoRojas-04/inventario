    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ url('presentacion/' . $presentacion->id) }}" method="POST">
                ...
                <input type="text" name="nombre" value="{{ $presentacion->nombre }}"
                ...
                <input type="text" name="descripcion" value="{{ $presentacion->descripcion }}" class="form-control @error('descripcion') is-invalid @enderror">
                @error('descripcion')
                <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
            @enderror
                <br>
