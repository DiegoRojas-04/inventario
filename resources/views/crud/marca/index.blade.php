                                ...
                                <div class="btn-group" role="group">
                                    @if ($marca->estado == 1)
                                        <button type="submit" class="btn btn-danger" data-toggle="modal"
                                            data-target="#eliminar-{{ $marca->id }}"><i class="fa fa-trash"
                                                aria-hidden="true"></i></button>
                                    @else
                                        <button type="submit" class="btn btn-success" data-toggle="modal"
                                            data-target="#eliminar-{{ $marca->id }}"><i class="fa fa-share"
                                                aria-hidden="true"></i></button>
                                    @endif
                                </div>
                            </td>
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">
                                            {{ $marca->estado == 1 ? 'Eliminar Marca' : 'Restaurar Marca' }} <br>
                                        </h5>
                                    ...
                                    <div class="modal-body">
                                        {{ $marca->estado == 1 ? ' ¿Estas seguro que quieres Eliminar esta Marca?' : '¿Estas seguro que quieres Restaurar esta Marca?' }}
                                        <br>
                                        <h5>{{ $marca->nombre }}</h5>
                                    </div>
