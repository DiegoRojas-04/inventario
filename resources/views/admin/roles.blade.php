...
@section('content_header')
    ...
    <div class="form-row">
        <div class="col-sm-12 d-flex align-items-center justify-content-between">
            <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#agregar">Agregar Rol</button>
        </div>
    </div>
@stop
                                ...
                                <div class="btn-group" role="group">
                                    @if ($rol->estado == 1)
                                        <button type="submit" class="btn btn-danger" data-toggle="modal"
                                            data-target="#eliminar-{{ $rol->id }}"><i class="fa fa-trash"
                                ...
                                <div class="card-body">
                                    <form action="{{ url('/rol') }}" method="POST">
                                        ...
                                        <input type="text" name="nombre"
                                            ...
                                            value="{{ old('nombre') }}" placeholder="Nuevo Rol">
                                        @error('nombre')
