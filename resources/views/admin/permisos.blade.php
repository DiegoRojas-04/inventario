...
@section('content_header')
    ...
    <div class="form-row">
        <div class="col-sm-12 d-flex align-items-center justify-content-between">
            <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#agregar">Agregar Permiso</button>
        </div>
    </div>
@stop
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="{{ url('/permiso/' . $permiso->id . '/edit') }}"
                                ...
                                <div class="btn-group" role="group">
                                    @if ($permiso->estado == 1)
                                        <button type="submit" class="btn btn-danger" data-toggle="modal"
                                            data-target="#eliminar-{{ $permiso->id }}"><i class="fa fa-trash"
                    ...
                    <div class="modal-content">
                        <div class="modal-header bg-primary">
                            <h5 class="modal-title" id="exampleModalLabel">
                                <h1 class="card-title">Crear Permiso</h1>
                            </h5>
                                ...
                                <div class="card-body">
                                    <form action="{{ url('/permiso') }}" method="POST">
                                        ...
                                        <input type="text" name="nombre"
                                            ...
                                            value="{{ old('nombre') }}" placeholder="Nuevo Permiso">
                                        @error('nombre')
